...
public class LongestPalindrome {
    ...
    /**
     * from first to last, expand to get largest panlindrome
     * 1. when the number of character is odd,start from same location
     * 2. when the number of character is even, start from current and next
     * O(n^2)
     * @param s
     * @return
     */
    ...
    /**
     * from 2 location, expand left and right to reaching the whole string
     * if left is not equal right, not palindrome, break
     * update max size
     * O(n)
     * @param chars
     * @param left
