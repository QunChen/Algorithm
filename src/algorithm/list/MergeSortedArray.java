...
public class MergeSortedArray {
    ...
    /**
     * use two pointer, one point to the tail of one array and another point to the head of another array
     * swap if the value in the second array is larger than the first
     * O(min(a,b))
     * @param a
     * @param b
     */
